    ...
    <section <?= get_section_id($data) ?> class="cta-two-columns-image-left section-space-top">
        <div class="container">
            <div class="grid gap-[40px] lg:gap-[50px] lg:grid-cols-2 bg-color-accent-first rounded-[10px] p-[10px] md:p-[30px] lg:p-[10px]">
                ...
                <div data-aos="fade-in" data-aos-delay="1000" class="lg:order-1 relative overflow-hidden rounded-[10px] aspect-[1/0.75] sm:aspect-[1/0.54] lg:aspect-auto lg:min-h-[442px] bg-gradient-second">
