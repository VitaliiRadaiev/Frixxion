<section class="cta-two-columns-image-left section-space-top">
    <div class="container">
        <div class="grid gap-[40px] lg:grid-cols-[48.2%_1fr] bg-color-accent-first rounded-[10px] p-[10px] md:p-[30px] lg:p-[10px]">
            <div class="lg:order-2 md-max:pt-[30px] lg:py-[80px] lg:pr-[35px] lg:self-center">
            ...
            <div class="lg:order-1 relative overflow-hidden rounded-[10px] aspect-[1/0.75] sm:aspect-[1/0.54] lg:aspect-auto lg:min-h-[320px] bg-gradient-second">
