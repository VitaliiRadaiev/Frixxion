    ...
    <section <?= get_section_id($data) ?> class="grey-number-cards-three-columns section-space-top">
        <div class="container first-child-no-margin">
            ...
            <?php if (check($data['list'])): ?>
                <div data-aos="cascade-fade-in" class="cards-list mt-[30px] lg:mt-[50px] grid gap-[10px] md:gap-[20px] md:grid-cols-2 lg:grid-cols-3 md-and-lg-max:[&>*:last-child:nth-child(odd)]:col-span-2">
                    <?php
