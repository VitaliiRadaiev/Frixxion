...
<section class="grey-number-cards-four-columns section-space-top">
    <div class="container">
        ...
        <div class="cards-list mt-[30px] lg:mt-[50px] grid gap-[10px] md:gap-[20px] md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <?php
